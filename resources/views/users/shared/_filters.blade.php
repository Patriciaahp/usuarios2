<div class="container-fluid">
    <div class="nav-item p-4">
        <div class="container-sm row d-flex">
            ...
            <div class="row-1">
                <button href="#Filter" class="button tealOutline " data-toggle="collapse" type="button">
                ...
                <select class="form-select button tealOutline ml-5" aria-label="Default select example"
                        wire:model="per_page">
    ...
    <div class="container-sm">
        <div id="Filter" wire:ignore class="collapse mt-5 mb-5">
